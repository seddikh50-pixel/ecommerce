          ...
          <div className='w-full '>
            <div className='w-full flex flex-col space-y-2'>
                <div className='w-full relative'>
                    <input type="text" placeholder='Search and choose product' className='w-full text-sm bg-white px-3 py-[7px]' />
                    <Search className='absolute right-2 top-1' width={20}/>
                </div>
                 <div className='w-full relative'>
                    <input type="text" placeholder='Search and choose product' className='w-full text-sm bg-white px-3 focus:outline-gray-200 py-[7px]' />
                    <Search className='absolute right-2 top-1' width={20}/>
                </div>
