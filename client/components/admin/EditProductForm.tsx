...
const EditProductForm = ({product, categories, brands}: { product: Product | null, categories: category[], brands: brand[] }) => {
          ...
          <div className="p-6 bg-gray-50 min-h-screen">
            <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-xl p-6">
                <form onSubmit={editProduct} className='flex flex-col gap-6'>
                    ...
                    <div>
                        <input type="text" className='w-full p-3 border rounded-lg bg-gray-50 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500' placeholder='Product' name='name' defaultValue={product?.name}/>
                    </div>
                    <div>
                        <input type="number" className='w-full p-3 border rounded-lg bg-gray-50 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500' placeholder='Price' name='price' defaultValue={product?.price} />
                    </div>
                    <div>
                        <textarea name="description" className='w-full p-3 border rounded-lg bg-gray-50 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500' placeholder='Description' defaultValue={product?.description}></textarea>
                    </div>
                    <div>
